        ...
        <div id="sub">
            ...
            <section class="croptalk">
                <aside>
                    ...
                    <ul class="lnb">
                        <li><a href="./story.do">ëìë¬¼ì´ì¼ê¸°</a></li>
                        <li><a href="./grow.do">íë°­ê°ê¾¸ê¸°</a></li>
                        <li class="on"><a href="./school.do">ê·ëíêµ</a></li>
                    </ul>

                </aside>
                <article>
                    <nav>
                        <img src="../images/sub_nav_tit_cate3_school.png" alt="ê·ëíêµ"/>
                        <p>
                            HOME > ëìë¬¼ì´ì¼ê¸° > <em>ê·ëíêµ</em>
                        </p>
                    </nav>
