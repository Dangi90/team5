        ...
        <div id="sub">
            ...
            <section class="croptalk">
                <aside>
                    ...
                    <ul class="lnb">
                        <li><a href="/Farmstory_JSP/article/list.do?group=${param.group}&cate=${param.cate}">농작물이야기</a></li>
                        <li><a href="/Farmstory_JSP/article/list.do?group=${param.group}&cate=grow${param.cate}">텃밭가꾸기</a></li>
                        <li><a href="/Farmstory_JSP/article/list.do?group=${param.group}&cate=school${param.cate}">귀농학교</a></li>
                    </ul>
                </aside>
                <article>
                    <nav>
