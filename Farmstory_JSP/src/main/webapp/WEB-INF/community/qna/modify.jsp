...
<head>
    <meta charset="UTF-8">
    <title>팜스토리:: 1:1고객문의 글 수정하기</title>
          ...
          <div id="sub">
            ...
            <section class="community">
                <aside>
    				...
    				<li class="on"><a href="./qna.do?group=${param.group}&cate=qna">1:1고객문의</a></li>
  					<li><a href="./faq.do?group=${param.group}&cate=faq">자주묻는질문</a></li>
					</ul>
                </aside>
                <article>
                    <nav>
                        <img src="/Farmstory_JSP/images/sub_nav_tit_cate5_qna.png" alt="1:1고객문의"/>
                        <p>
