...
table th:nth-child(3), table td:nth-child(3), table th:nth-child(4),
	table td:nth-child(4), table th:nth-child(5), table td:nth-child(5) {
	text-align: center;
}
...
<body>
	<div id="container">
		...
		<div id="sub">
			<div>
				<img src="/Farmstory_JSP/images/sub_top_tit5.png" alt="COMMUNITY">
			</div>
			<section class="community">
				<aside>
					...
					<ul class="lnb">
						...
						<li class="on"><a
							href="./list.do?group=${param.group}&cate=faq">자주묻는질문</a></li>
					</ul>

				</aside>
				<article>
					<nav>
						<img src="/Farmstory_JSP/images/sub_nav_tit_cate5_faq.png"
							alt="자주묻는질문" />
						<p>
					...
					<div class="search-bar">
						<form action="search.jsp" method="get">
							...
							</select> <input type="text" name="searchQuery" placeholder="검색어 입력" />
							<input type="submit" value="검색" /> <input type="radio"
								name="searchOption" value="and" checked /> and <input
								type="radio" name="searchOption" value="or" /> or
						</form>
						<button
							onclick="location.href='/Farmstory_JSP/article/write.do?group=${group}&cate=${cate}'"
							style="padding: 5px 10px; background-color: #333; color: #fff; border: none; cursor: pointer; margin-left: 10px;">
							글쓰기</button>
					</div>
				</article>
			</section>
