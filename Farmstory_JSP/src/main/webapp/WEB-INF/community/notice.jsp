    ...
    <div id="container">
        ...
        <div id="sub">
            ...
            <section class="community">
                <aside>
                    <img src="../images/sub_aside_cate5_tit.png" alt="ì»¤ë®¤ëí°"/>

                    <ul class="lnb">
                        <li class="on"><a href="./notice.do">ê³µì§ì¬í­</a></li>
                        <li><a href="./menu.do">ì¤ëììë¨</a></li>
                        <li><a href="./chef.do">ëëìë¦¬ì¬</a></li>
                        <li><a href="./qna.do">1:1ê³ ê°ë¬¸ì</a></li>
                        <li><a href="./faq.do">ìì£¼ë¬»ëì§ë¬¸</a></li>
                    </ul>

                </aside>
                <article>
                    <nav>
                        <img src="../images/sub_nav_tit_cate5_notice.png" alt="ê³µì§ì¬í­"/>
                        <p>
                            HOME > ì»¤ë®¤ëí° > <em>ê³µì§ì¬í­</em>
                        </p>
                    </nav>

                    <!-- ë´ì© ìì -->
                        <p>ê²ìí ê¸ëª©ë¡/ê¸ì°ê¸°/ê¸ë³´ê¸°/ê¸ìì  íë©´ ì¶ë ¥</p>
                    <!-- ë´ì© ë -->
