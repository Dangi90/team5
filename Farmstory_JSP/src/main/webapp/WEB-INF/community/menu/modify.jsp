		...
		<div id="sub">
			...
			<section class="community">
				<aside>
					...
					<ul class="lnb">
						<li><a
							href="./list.do?group=${param.group}&cate=notice">공지사항</a></li>
				...
				<article>
					<nav>
						<img src="/Farmstory_JSP/images/sub_nav_tit_cate5_menu.png"
							alt="오늘의식단" />
						<p>
					...
					<!-- 글 수정하기 시작 -->
					<h2>수정</h2>
					<form action="modify.do?group=${param.group}&cate=${param.cate}"
						method="post">
						...
						<div class="form-buttons">
							<input type="button" value="취소"
								onclick="history.back(); this.form.reset();"> <input
